...
async function seedInitialData() {
  ...
  const initialClusters = [
    {
      id: 'AC-101',
      region_name: 'Solang Valley North Trail',
      risk_score: 88,
      tourist_density: 142,
      anomaly_type: 'TRAIL_DEVIATION',
      confidence_score: 94,
      description_en: 'AI detected 3 active tourist digital bands deviating more than 2 km from the marked trekking trail after dusk.',
    ...
    {
      id: 'AC-102',
      region_name: 'Triund–McLeod Ganj Trek Corridor',
      risk_score: 84,
      tourist_density: 890,
      anomaly_type: 'TRAIL_DEVIATION',
      confidence_score: 89,
      description_en: 'AI detected multiple tourist devices deviating from the designated trekking route in a low-visibility section after dusk.',
      description_hi: 'एआई ने सूर्यास्त के बाद कम दृश्यता वाले हिस्से में निर्दिष्ट ट्रैकिंग मार्ग से भटकने वाले कई पर्यटक उपकरणों का पता लगाया।',
      recommended_action_en: 'Dispatch rescue team from McLeod Ganj base station and activate trail marker lights.',
      recommended_action_hi: 'मैक्लोडगंज बेस स्टेशन से बचाव दल भेजें और ट्रेल मार्कर लाइटों को सक्रिय करें।',
      lat: 32.2426,
      lng: 76.3242,
    ...
    {
      id: 'AC-103',
      region_name: 'Rohtang Pass–Gulaba Corridor',
      risk_score: 86,
      tourist_density: 210,
      anomaly_type: 'ROUTE_DEVIATION',
      confidence_score: 91,
      description_en: 'Abnormal movement patterns and route deviations detected near the high-altitude road corridor. Reduced device movement and intermittent GPS signals triggered an anomaly.',
      description_hi: 'उच्च ऊंचाई वाले सड़क गलियारे के पास असामान्य गति पैटर्न और मार्ग विचलन का पता चला। कम डिवाइस मूवमेंट और आंतरायिक जीपीएस संकेतों ने एक विसंगति को जन्म दिया।',
      recommended_action_en: 'Deploy traffic safety patrol unit and trigger automated route deviation warning SMS.',
      recommended_action_hi: 'यातायात सुरक्षा गश्ती इकाई तैनात करें और स्वचालित मार्ग विचलन चेतावनी एसएमएस ट्रिगर करें।',
      lat: 32.3716,
      lng: 77.2464,

...
export const ANOMALY_CLUSTERS: AnomalyCluster[] = [
  {
    id: 'AC-101',
    regionName: 'Solang Valley North Trail',
    riskScore: 88,
    touristDensity: 142,
    anomalyType: 'TRAIL_DEVIATION',
    confidenceScore: 94,
    descriptionEn: 'AI detected 3 active tourist digital bands deviating more than 2 km from the marked trekking trail after dusk.',
  ...
  {
    id: 'AC-102',
    regionName: 'Triund–McLeod Ganj Trek Corridor',
    riskScore: 84,
    touristDensity: 890,
    anomalyType: 'TRAIL_DEVIATION',
    confidenceScore: 89,
    descriptionEn: 'AI detected multiple tourist devices deviating from the designated trekking route in a low-visibility section after dusk.',
    descriptionHi: 'एआई ने सूर्यास्त के बाद कम दृश्यता वाले हिस्से में निर्दिष्ट ट्रैकिंग मार्ग से भटकने वाले कई पर्यटक उपकरणों का पता लगाया।',
    recommendedActionEn: 'Dispatch rescue team from McLeod Ganj base station and activate trail marker lights.',
    recommendedActionHi: 'मैक्लोडगंज बेस स्टेशन से बचाव दल भेजें और ट्रेल मार्कर लाइटों को सक्रिय करें।',
    coordinates: { lat: 32.2426, lng: 76.3242 },
    timestamp: '2026-08-12 08:05:00'
  },
  {
    id: 'AC-103',
    regionName: 'Rohtang Pass–Gulaba Corridor',
    riskScore: 86,
    touristDensity: 210,
    anomalyType: 'ROUTE_DEVIATION',
    confidenceScore: 91,
    descriptionEn: 'Abnormal movement patterns and route deviations detected near the high-altitude road corridor. Reduced device movement and intermittent GPS signals triggered an anomaly.',
    descriptionHi: 'उच्च ऊंचाई वाले सड़क गलियारे के पास असामान्य गति पैटर्न और मार्ग विचलन का पता चला। कम डिवाइस मूवमेंट और आंतरायिक जीपीएस संकेतों ने एक विसंगति को जन्म दिया।',
    recommendedActionEn: 'Deploy traffic safety patrol unit and trigger automated route deviation warning SMS.',
    recommendedActionHi: 'यातायात सुरक्षा गश्ती इकाई तैनात करें और स्वचालित मार्ग विचलन चेतावनी एसएमएस ट्रिगर करें।',
    coordinates: { lat: 32.3716, lng: 77.2464 },
